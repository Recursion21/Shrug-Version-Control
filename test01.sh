...
# longer generic test on subset 0
...
shrug-commit -m "2nd com" >> output1.txt
shrug-commit -m "3rd com" >> output1.txt
shrug-add b >> output1.txt
shrug-commit -m "4th com" >> output1.txt
shrug-add c >> output1.txt
shrug-commit -m "5th com" >> output1.txt
shrug-log >> output1.txt
...
2041 shrug-commit -m "2nd com" >> output2.txt
2041 shrug-commit -m "3rd com" >> output2.txt
2041 shrug-add b >> output2.txt
2041 shrug-commit -m "4th com" >> output2.txt
2041 shrug-add c >> output2.txt
2041 shrug-commit -m "5th com" >> output2.txt
2041 shrug-log >> output2.txt
